...
from app.utils.get_docker_ip import get_docker_ip
from app.infra.verify_redis import check_redis
from app.services.elevator_service import Elevator

# load_dotenv()
app = FastAPI(lifespan=lifespan)
ip = get_docker_ip()
check_redis(ip)
app.state.redis_url = f'redis://{ip}:6379'
...
elevator = Elevator()
redis_pub = redis.from_url(app.state.redi_url)
